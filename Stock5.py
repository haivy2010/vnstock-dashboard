...
class ReportGenerator:
    ...
    def _calculate_all_stocks_performance(self, period, start_date=None, end_date=None):
        ...
        for symbol in self.stock_data.get_available_symbols():
            try:
                ...
                if data is not None:
                    ...
                    if not processed_data.empty:
                        ...
                        volatility = processed_data['Price Close'].pct_change().std() * 100
    ...
    def _add_technical_analysis_summary(self, pdf, top_performers):
        ...
        for stock in top_performers:
            ...
            Signal: {latest_data['MACDs_12_26_9']:.2f}
            Volume Trend: {'Increasing' if ta_data['Volume'].iloc[-1] > ta_data['Volume'].iloc[-5:].mean() else 'Decreasing'}
            """)
            pdf.ln(5)
def main():
